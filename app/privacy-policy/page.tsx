            ...
            <div className="col-md-12 col-sm-12">
                <div className="text">
                    ...
                    <p>
                        ...
                        <strong>Website:</strong> <a href="https://oniva.app/" rel="noopener"> https://oniva.app</a>
                    </p>
                </div>
            </div>
          </div>

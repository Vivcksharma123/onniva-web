          ...
          <div className="row">
            <div className="col-md-12 col-sm-12">
                <div className="text">
                    ...
                    <p>
                        Welcome to <strong>Oniva</strong> (“we,” “our,” or “us”). By accessing or using our website <a href="https://mywebprovider.com/oniva/" target="_blank" rel="noopener">https://mywebprovider.com/oniva/</a> and related services, including AI chatbots, AI email responders, and AI representatives (collectively, the “Services”), you agree to comply with and be bound by these Terms of Use.
                    </p>
                    ...
                    <p>
                        All content on this website, including text, graphics, logos, software, and AI models, 
                        is the property of Oniva or its licensors and is protected by intellectual property laws.
                    </p>
                    <p>
                    ...
                    <p>
                        Our Services may integrate or link to third-party platforms, tools, or websites. 
                        Oniva is not responsible for the content, policies, or practices of any third-party services. 
                    ...
                    <p>
                        ...
                        or accuracy of AI-generated outputs.
                    </p>
                    <h3>8. Termination</h3>
                    <p>
                        We reserve the right to suspend or terminate your access to the Services at any time, 
                        without notice, if you violate these Terms or engage in activities that may harm Oniva or its users.
                    </p>
                    <h3>9. Changes to Terms</h3>
                    <p>
                        We may update these Terms of Use from time to time. Any changes will be effective immediately upon posting. 
                    ...
                    <p>
                        <strong>Email:</strong> <a href="mailto:support@oniva.app"> support@oniva.app</a><br />
                        <strong>Website:</strong> <a href="https://mywebprovider.com/oniva/" target="_blank" rel="noopener"> https://mywebprovider.com/oniva/</a>
                    </p>
                </div>
            </div>
          </div>
